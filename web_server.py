...
<div class="shell">
  ...
  <main class="wrap">
    <section id="task" class="chat-panel">
      <div class="chat-header"><div><div class="chat-title">AI WORKSPACE</div><span class="chat-subtitle">DIRECT CONVERSATION · LOCAL AGENT · BOUNDED ACTIONS</span></div><div class="chat-meta"><span id="ready" class="badge">AGENT: CHECKING</span><select id="model" aria-label="Model"><option value="gemini-3.6-flash">GEMINI FLASH</option><option value="gemini-flash-lite-latest">GEMINI LITE</option></select></div></div>
