...
REQUIRED = {
    ...
    "self_update": {"path": str, "content": str}, "create_file": {"path": str, "content": str}, "move_file": {"source": str, "destination": str}, "delete_file": {"path": str}, "verify_python": {"path": str}, "verify_tool": {"requested": str}, "install_and_verify": {"requested": str}, "search_web": {"query": str}, "install_plugin": {"archive": str}, "parallel_analysis": {"tasks": list}, "preview_diff": {"path": str}, "git_checkpoint": {"label": str},
    "ocr": {"path": str}, "open_app": {"target": str}, "terminate_process": {"pid": int},
...
def validate_tool_args(name: str, args: Any) -> tuple[bool, str]:
    ...
    if name in {"read_file", "write_file", "self_update", "verify_python", "ocr"} and len(str(args.get("path", ""))) > 4096:
